...
btncorbasepreto.addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#A3AA7E");
  document.getElementById('CB').style.backgroundColor = "#A3AA7E";
});
//base azul
const btncorbaseazul = document.getElementById('bluebase');
btncorbaseazul.addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#848E8D");
  document.getElementById('CB').style.backgroundColor = "#848E8D";
});    
//base vermelha
const btncorbasevermelha = document.getElementById('redbase');
btncorbasevermelha.addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#5E6A66");
  document.getElementById('CB').style.backgroundColor = "#5E6A66";
});  
//base amarela
const btncorbaseamarela = document.getElementById('yellowbase');
btncorbaseamarela.addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#90AAAF");
  document.getElementById('CB').style.backgroundColor = "#90AAAF";
});  
//base verde
const btncorbaseverde = document.getElementById('greenbase');
btncorbaseverde.addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#5E96BA");
  document.getElementById('CB').style.backgroundColor = "#5E96BA";
});  

document.getElementById('base1').addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#768AA7");
  document.getElementById('CB').style.backgroundColor = "#768AA7";
});  
document.getElementById('base2').addEventListener('click', function(e){
  ...
  btncorbotoespreto.addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#A3AA7E";
    document.getElementById('BT').style.backgroundColor = "#A3AA7E";
  });
  //botoes azul
  const btncorbotoesazul = document.getElementById('bluebase1');
  btncorbotoesazul.addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#848E8D";
    document.getElementById('BT').style.backgroundColor = "#848E8D";
  });    
  //botoes vermelha
  const btncorbotoesvermelha = document.getElementById('redbase1');
  btncorbotoesvermelha.addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#5E6A66";
    document.getElementById('BT').style.backgroundColor = "#5E6A66";
  });  
  //botoes amarela
  const btncorbotoesamarela = document.getElementById('yellowbase1');
  btncorbotoesamarela.addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#90AAAF";
    document.getElementById('BT').style.backgroundColor = "#90AAAF";
  });  
  //botoes verde
  const btncorbotoesverde = document.getElementById('greenbase1');
  btncorbotoesverde.addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#5E96BA";
    document.getElementById('BT').style.backgroundColor = "#5E96BA";
  });  

  document.getElementById('base11').addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#768AA7";
    document.getElementById('BT').style.backgroundColor = "#768AA7";
  });  
  ...
  btncorgolaEpreto.addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#A3AA7E";
    document.getElementById('golaEE').style.fill = "#A3AA7E";
    document.getElementById('ge').style.backgroundColor = "#A3AA7E";
  });
  //Gola exterior azul
  const btncorgolaEazul = document.getElementById('bluebase2');
  btncorgolaEazul.addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#848E8D";
    document.getElementById('golaEE').style.fill = "#848E8D";
    document.getElementById('ge').style.backgroundColor = "#848E8D";
  });    
  ...
  btncorgolaEvermelha.addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#5E6A66";
    document.getElementById('golaEE').style.fill = "#5E6A66";
    document.getElementById('ge').style.backgroundColor = "#5E6A66";
  });  
  ...
  btncorgolaEamarela.addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#90AAAF";
    document.getElementById('golaEE').style.fill = "#90AAAF";
    document.getElementById('ge').style.backgroundColor = "#90AAAF";
  });  
  //Gola exterior verde
  const btncorgolaEverde = document.getElementById('greenbase2');
  btncorgolaEverde.addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#5E96BA";
    document.getElementById('golaEE').style.fill = "#5E96BA";
    document.getElementById('ge').style.backgroundColor = "#5E96BA";
  });  
  document.getElementById('base12').addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#768AA7";
    document.getElementById('golaEE').style.fill = "#768AA7";
    document.getElementById('ge').style.backgroundColor = "#768AA7";
  });  
  ...
  btncorgolaIpreto.addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#A3AA7E";
    document.getElementById('gi').style.backgroundColor = "#A3AA7E";
  });
  //Gola interior azul
  const btncorgolaIazul = document.getElementById('bluebase3');
  btncorgolaIazul.addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#848E8D";
    document.getElementById('gi').style.backgroundColor = "#848E8D";
  });    
  ...
  btncorgolaIvermelha.addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#5E6A66";
    document.getElementById('gi').style.backgroundColor = "#5E6A66";
  });  
  ...
  btncorgolaIamarela.addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#90AAAF";
    document.getElementById('gi').style.backgroundColor = "#90AAAF";
  });  
  //Gola interior verde
  const btncorgolaIverde = document.getElementById('greenbase3');
  btncorgolaIverde.addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#5E96BA";
    document.getElementById('gi').style.backgroundColor = "#5E96BA";
  });  
  document.getElementById('base13').addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#768AA7";
    document.getElementById('gi').style.backgroundColor = "#768AA7";
  });  
...
//punho branca
  ...
  btncorpunhopreto.addEventListener('click', function(e){
    document.getElementById('punho2').style.fill = "#A3AA7E";
    document.getElementById('punho1').style.fill = "#A3AA7E";
    document.getElementById('PU').style.backgroundColor = "#A3AA7E";
  });
  //punho azul
  const btncorpunhoazul = document.getElementById('bluebase4');
  btncorpunhoazul.addEventListener('click', function(e){
    document.getElementById('punho2').style.fill = "#848E8D";
    document.getElementById('punho1').style.fill = "#848E8D";
    document.getElementById('PU').style.backgroundColor = "#848E8D";
  });    
  //punho vermelha
  const btncorpunhovermelha = document.getElementById('redbase4');
  btncorpunhovermelha.addEventListener('click', function(e){
    document.getElementById('punho2').style.fill = "#5E6A66";
    document.getElementById('punho1').style.fill = "#5E6A66";
    document.getElementById('PU').style.backgroundColor = "#5E6A66";
  });  
  //punho amarela
  const btncorpunhoamarela = document.getElementById('yellowbase4');
  btncorpunhoamarela.addEventListener('click', function(e){
    document.getElementById('punho2').style.fill = "#90AAAF";
    document.getElementById('punho1').style.fill = "#90AAAF";
    document.getElementById('PU').style.backgroundColor = "#90AAAF";
  });  
  //punho verde
  const btncorpunhoverde = document.getElementById('greenbase4');
  btncorpunhoverde.addEventListener('click', function(e){
    document.getElementById('punho2').style.fill = "#5E96BA";
    document.getElementById('punho1').style.fill = "#5E96BA";
    document.getElementById('PU').style.backgroundColor = "#5E96BA";
  });
  ...
  btncorvistaEpreto.addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#A3AA7E";
    document.getElementById('VE').style.backgroundColor = "#A3AA7E";
  });
  //vistaE azul
  const btncorvistaEazul = document.getElementById('bluebase5');
  btncorvistaEazul.addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#848E8D";
    document.getElementById('VE').style.backgroundColor = "#848E8D";
  });    
  //vistaE vermelha
  const btncorvistaEvermelha = document.getElementById('redbase5');
  btncorvistaEvermelha.addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#5E6A66";
    document.getElementById('VE').style.backgroundColor = "#5E6A66";
  });  
  //vistaE amarela
  const btncorvistaEamarela = document.getElementById('yellowbase5');
  btncorvistaEamarela.addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#90AAAF";
    document.getElementById('VE').style.backgroundColor = "#90AAAF";
  });  
  //vistaE verde
  const btncorvistaEverde = document.getElementById('greenbase5');
  btncorvistaEverde.addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#5E96BA";
    document.getElementById('VE').style.backgroundColor = "#5E96BA";
  });

  document.getElementById('base15').addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#768AA7";
    document.getElementById('VE').style.backgroundColor = "##768AA7";
  });
  ...
  btncorvistaDpreto.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#A3AA7E";
    document.getElementById('VD').style.backgroundColor = "#A3AA7E";
  });
  //vistaD azul
  const btncorvistaDazul = document.getElementById('bluebase6');
  btncorvistaDazul.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#848E8D";
    document.getElementById('VD').style.backgroundColor = "#848E8D";
  });    
  //vistaD vermelha
  const btncorvistaDvermelha = document.getElementById('redbase6');
  btncorvistaDvermelha.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#5E6A66";
    document.getElementById('VD').style.backgroundColor = "#5E6A66";
  });  
  //vistaD amarela
  const btncorvistaDamarela = document.getElementById('yellowbase6');
  btncorvistaDamarela.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#90AAAF";
    document.getElementById('VD').style.backgroundColor = "#90AAAF";
  });  
  //vistaD verde
  const btncorvistaDverde = document.getElementById('greenbase6');
  btncorvistaDverde.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#5E96BA";
    document.getElementById('VD').style.backgroundColor = "#5E96BA";
  });
  ...
  btncorbolsoFpreto.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#A3AA7E";
    document.getElementById('BSF').style.backgroundColor = "#A3AA7E";
  });
  //Bolso Faixa azul
  const btncorbolsoFazul = document.getElementById('bluebase7');
  btncorbolsoFazul.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#848E8D";
    document.getElementById('BSF').style.backgroundColor = "#848E8D";
  });    
  ...
  btncorbolsoFvermelha.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#5E6A66";
    document.getElementById('BSF').style.backgroundColor = "#5E6A66";
  });  
  //Bolso Faixa amarela
  const btncorbolsoFamarela = document.getElementById('yellowbase7');
  btncorbolsoFamarela.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#90AAAF";
    document.getElementById('BSF').style.backgroundColor = "#90AAAF";
  });  
  //Bolso Faixa verde
  const btncorbolsoFverde = document.getElementById('greenbase7');
  btncorbolsoFverde.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#5E96BA";
    document.getElementById('BSF').style.backgroundColor = "#5E96BA";
  });
  ...
  btncorbolsoBpreto.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#A3AA7E";
    document.getElementById('BB').style.backgroundColor = "#A3AA7E";
  });
  //Bolso Faixa azul
  const btncorbolsoBazul = document.getElementById('bluebase8');
  btncorbolsoBazul.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#848E8D";
    document.getElementById('BB').style.backgroundColor = "#848E8D";
  });    
  //Bolso Faixa vermelha
  const btncorbolsoBvermelha = document.getElementById('redbase8');
  btncorbolsoBvermelha.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#5E6A66";
    document.getElementById('BB').style.backgroundColor = "#5E6A66";
  });  
  //Bolso Faixa amarela
  const btncorbolsoBamarela = document.getElementById('yellowbase8');
  btncorbolsoBamarela.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#90AAAF";
    document.getElementById('BB').style.backgroundColor = "#90AAAF";
  });  
  //Bolso Faixa verde
  const btncorbolsoBverde = document.getElementById('greenbase8');
  btncorbolsoBverde.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#5E96BA";
    document.getElementById('BB').style.backgroundColor = "#5E96BA";
  });
